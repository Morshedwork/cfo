  ...
  return (
    <div className="page-transition">
      <div className="container py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Growth Scenarios</h1>
          <p className="text-muted-foreground">Simulate hires, marketing spend, and revenue changes. Data-driven scaling decisions.</p>
        </div>
