...
export async function POST(request: NextRequest) {
  try {
    ...
    const { query, userId, recentMessages, competitors: bodyCompetitors, currentSection, stream: wantStream } = body
    ...
    console.log("[Voice API] Processing query (conversational, full context):", query.slice(0, 60), "… | context turns:", messages.length, wantStream ? "| stream" : "")
